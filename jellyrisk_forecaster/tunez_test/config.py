...
settings.MOTU_CLIENT_RETRIES = getattr(settings, 'MOTU_CLIENT_RETRIES', 3)
settings.MOTU_CLIENT_RETRY_DELAY_SECS = getattr(settings, 'MOTU_CLIENT_RETRY_DELAY_SECS', 5)
